...
{
    /**
     * Data provider for testDateRanges()
     *
     * @return array
     */
    public function getDateRangeResults(): array
    {
        return [
            [
                'qdc_dateranges',
     ...
     * Test dateranges
     *
     * @param string $xmlFile  Name of the XML-file to use
     * @param array  $expected Results to be expected
     *
     * @return void
     *
     * @dataProvider getDateRangeResults
     */

...
/**
 * Finna EAC-CPF Record Driver Test Class
 *
 * PHP version 8
 *
...
use RecordManager\Finna\Record\Eaccpf;
 ...
 * @link     https://github.com/NatLibFi/RecordManager
 */
class EaccpfTest extends \RecordManagerTest\Base\Record\RecordTestBase
{
    /**
    ...
    public function testEaccpf1()
    {
        ...
        $expected = [
            ...
            'language' => 'fin',
            'agency_str_mv' => 'Kansallisarkisto',
